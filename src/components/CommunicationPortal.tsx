  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Optionally update frontend message with actual id
      }
    } catch (err) {
              ...
              <div className="lg:col-span-2">
                <Card className="border-blue-100 shadow-md">
                  <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50">
                    ...
                    <CardDescription>
                      Stay connected with your couple throughout the planning
                      process
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-6">
                    <div className="space-y-4 max-h-96 overflow-y-auto mb-6">
                      {aiChatMessages.map((message) => (
                        <div
                          key={message.id}
                          className={`flex space-x-3 ${message.role === "assistant"
                            ? "justify-start"
                            : "justify-end"
                            }`}
                        >
                          ...
                          <div
                            className={`flex-1 max-w-xs lg:max-w-md ${message.role === "assistant" ? "" : "order-first"
                              }`}
                          >
                            <div
                              className={`p-4 rounded-xl shadow-sm ${message.role === "assistant"
