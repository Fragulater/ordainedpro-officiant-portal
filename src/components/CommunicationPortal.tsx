...
pastor.michael@ordainedpro.com`,
  ...
  const sendCoupleMessage = async (sendEmail: boolean = false) => {
    ...
    const messageData = {
      ...
      recipient_email: editCoupleInfo.brideEmail || editCoupleInfo.groomEmail || "",
      content: newMessage,
      read: false,
      created_at: new Date().toISOString(),
    };
    ...
    try {
      ...
      if (error) {
        ...
        setCoupleMessages((prev) => prev.filter((m) => m.id !== Date.now()));
        return;
      }
...
const emails = [editCoupleInfo.brideEmail, editCoupleInfo.groomEmail].filter(Boolean);
                    ...
                    <div className="space-y-3">
                      <div className="flex space-x-2">
                        <Input
                          ...
                          onKeyPress={(e) =>
                            e.key === "Enter" && sendCoupleMessage(false)
                          }
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          onClick={() => sendCoupleMessage(false)}
