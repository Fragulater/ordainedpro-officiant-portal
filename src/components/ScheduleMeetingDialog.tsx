...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
      ...
      let emailsSent = 0;
      for (const email of formData.attendees) {
        if (!email) continue;
      ...
      console.log(`📧 Meeting invites sent: ${emailsSent}/${formData.attendees.length}`);
      ...
      const newMeeting: Meeting = {
        ...
        status: "pending",
        reminderSent: false,
        calendarInviteSent: emailsSent > 0,
      };
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={type.value}
                    className={`relative cursor-pointer rounded-lg border-2 p-3 transition-all hover:bg-gray-50 ${formData.meetingType === type.value
