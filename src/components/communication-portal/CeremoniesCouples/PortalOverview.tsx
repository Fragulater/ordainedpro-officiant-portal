...
import { FileText, Users, Clock, MapPin, Phone, Mail, User, Star, Edit, Save, StickyNote } from "lucide-react"
              ...
              <div className="space-y-4">
                ...
                {editCoupleInfo?.brideAddress && (
                  <div className="pl-12 text-sm text-gray-600 flex items-start">
                    <MapPin className={`w-4 h-4 mr-2 mt-0.5 flex-shrink-0 ${colors.brideIcon || 'text-pink-500'}`} />
                ...
                {editCoupleInfo?.groomAddress && (
                  <div className="pl-12 text-sm text-gray-600 flex items-start">
                    <MapPin className={`w-4 h-4 mr-2 mt-0.5 flex-shrink-0 ${colors.groomIcon || 'text-blue-500'}`} />
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center text-gray-600 hover:text-blue-600 transition-colors">
                    ...
                    {editCoupleInfo?.bridePhone || 'No phone'}
                  </div>
                  <div className="flex items-center text-gray-600 hover:text-blue-600 transition-colors">
                    <Mail className="w-4 h-4 mr-2" />
                    {editCoupleInfo?.brideEmail || 'No email'}
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-blue-100 shadow-md hover:shadow-lg transition-shadow">
            ...
            <CardContent className="pt-6">
              <div className="space-y-4 text-sm">
                ...
                {/* Notes Button - Green if notes exist, Gray if not */}
                    ...
                    <DialogContent className="max-w-2xl max-h-[80vh]">
                      <DialogHeader>
                        <DialogTitle className="flex items-center text-blue-900">
                          <StickyNote className="w-5 h-5 mr-2 text-green-600" />
                          Officiant Notes
                        </DialogTitle>
                        <DialogDescription>
                          Private notes for {editCoupleInfo?.brideName?.split(' ')[0]} & {editCoupleInfo?.groomName?.split(' ')[0]}'s wedding.
                          These notes are stored on the server and will persist across sessions.
                        </DialogDescription>
                      </DialogHeader>
                        ...
                        {hasNotes ? (
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 text-center">
                            ...
                            <p className="text-gray-400 text-xs mt-1">
                              Click "Edit" to add notes for this wedding.
                            </p>
                          </div>
                        )}
                      </div>
